...
class WebUI:
    ...
    def _setup_routes(self):
        ...
        def get_photo(filepath):
            ...
            try:
                # Security check: ensure the file is in one of the allowed directories
        ...
        def delete_photo(filepath):
            ...
            try:
                ...
                logger.info(f"Deleted photo: {abs_filepath}")
        ...
        def add_directory():
            ...
            try:
                ...
                if directory not in self.image_directories:
                    ...
                    logger.info(f"Added image directory: {directory}")
        ...
        def remove_directory(index):
            ...
            try:
                if 0 <= index < len(self.image_directories):
                    ...
                    logger.info(f"Removed image directory: {removed}")
                    return jsonify(
                        {
                            "success": True,
...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        action="append",
        help="Directory containing captured images (can be used multiple times)",
    )
